              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`flex-1 h-10 md:h-9 rounded-md border-2 transition-colors cursor-pointer bg-warning ${
                      editing?.color === "YELLOW" ? "border-warning-border ring-2 ring-warning-border/40" : "border-warning-border/50 hover:border-warning-border"
                    }`}
                  >
                    <span className="text-base md:text-xs font-medium text-warning-foreground">Yellow</span>
                  </button>
                  <button
                    type="button"
                    onClick={() => patchEditing({ color: "GRAY" })}
                    className={`flex-1 h-10 md:h-9 rounded-md border-2 transition-colors cursor-pointer bg-muted ${
                      editing?.color === "GRAY" ? "border-foreground/30 ring-2 ring-border" : "border-border hover:border-foreground/20"
                    }`}
                  >
                    <span className="text-base md:text-xs font-medium text-muted-foreground">Gray</span>
                  </button>
                </div>
              </div>
              <div className="space-y-2">
